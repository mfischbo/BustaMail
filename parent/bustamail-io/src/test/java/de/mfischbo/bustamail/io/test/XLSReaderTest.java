...
public class XLSReaderTest {
	...
	public void canReadXLSXFromODT() throws Exception {
		InputStream in = getClass().getResourceAsStream("/odt-xls-default.xls");
		TableDataReader reader = new TableDataReader(in, "application/ms-office", "odt-xls-default.xls");
