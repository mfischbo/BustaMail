...
public class RestTemplatePackController extends BaseApiController {
	...
	public Page<TemplatePackIndexDTO> getAllTemplatePacks(@PathVariable("owner") ObjectId owner, @PageableDefault(page =0, size=30, sort="name") Pageable page) {
	...
	public TemplatePackDTO getTemplatePackById(@PathVariable("id") ObjectId id) throws Exception {
	...
	public MediaImageDTO createThemeImage(@PathVariable("id") ObjectId packId, MultipartFile file) throws Exception {
	...
	public TemplatePackDTO cloneTemplatePack(@PathVariable("id") ObjectId id) throws Exception {
	...
	public TemplatePackDTO updateTemplatePack(@PathVariable("id") ObjectId id, @RequestBody TemplatePackDTO dto) throws Exception {
	...
	public TemplatePackIndexDTO uploadTemplatePack(@PathVariable("owner") ObjectId owner, MultipartFile file) throws Exception {
